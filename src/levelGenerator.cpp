...
Stage *baseGenerator() {
    ...
    for (int i = 0; i < numGrass; ++i) {
        Entity *tGrass = new Entity("Grass", rand()%(floorWidth-(32 * (SCALE_FACTOR / 2))), rand()%(floorHeight-(32 * (SCALE_FACTOR / 2))), 32 * (SCALE_FACTOR / 2), 32 * (SCALE_FACTOR / 2), TallGrass, 1, 0, 0, 1);
    ...
    for (int i = 0; i < numBirds; ++i) {
        Entity *bird = new Entity("Bird", rand()%(floorWidth-(32 * (SCALE_FACTOR / 5))), rand()%(floorHeight-(32 * (SCALE_FACTOR / 5))), 32 * (SCALE_FACTOR / 5), 32 * (SCALE_FACTOR / 5), Bird, 5, 5, 0, 50);
    ...
    for (int i = 0; i < numCats; ++i) {
        Entity *cat = new Entity("Cat", rand()%(floorWidth-(32 * (SCALE_FACTOR / 5))), rand()%(floorHeight-(32 * (SCALE_FACTOR / 5))), 32 * (SCALE_FACTOR / 5), 32 * (SCALE_FACTOR / 5), Cat, 15, 5, 0, 20);
